...
const FOOTER_LINKS = {
  services: {
    title: 'Dịch vụ',
    links: [
      { label: 'Luật Doanh nghiệp', href: '/dich-vu/luat-doanh-nghiep' },
      { label: 'Luật Đất đai', href: '/dich-vu/luat-dat-dai' },
      { label: 'Luật Dân sự', href: '/dich-vu/luat-dan-su' },
      { label: 'Luật Hình sự', href: '/dich-vu/luat-hinh-su' },
      { label: 'Luật Lao động', href: '/dich-vu/luat-lao-dong' },
      { label: 'Soạn thảo hợp đồng', href: '/dich-vu/soan-thao-hop-dong' },
    ],
  },
  company: {
    title: 'Công ty',
    links: [
      ...
      { label: 'Đội ngũ luật sư', href: '/luat-su' },
      { label: 'Blog pháp luật', href: '/blog' },
    ...
    <footer className="footer">
      <div className="container">
        <div className="footer__top">
          ...
          <div>
            <h4 className="footer__col-title">{FOOTER_LINKS.services.title}</h4>
          ...
          <div>
            <h4 className="footer__col-title">{FOOTER_LINKS.company.title}</h4>
            <div className="footer__links">
          ...
          <div>
            <h4 className="footer__col-title">{FOOTER_LINKS.contact.title}</h4>
            <div>
