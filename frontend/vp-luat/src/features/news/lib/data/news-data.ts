...
export const NEWS_CATEGORIES: NewsCategoryFilter[] = [
  // Counts are intentionally omitted (`count: 0`); derive them from the live
  // posts in the consumer component instead of letting them go stale.
  { id: 'all', label: 'Tất cả', count: 0, slug: 'all', icon: 'fa-solid fa-layer-group' },
  { id: 'tin-tuc', label: 'Tin tức', count: 0, slug: 'tin-tuc', icon: 'fa-solid fa-newspaper' },
  { id: 'nghi-dinh', label: 'Nghị định', count: 0, slug: 'nghi-dinh', icon: 'fa-solid fa-scale-balanced' },
  { id: 'blog', label: 'Blog', count: 0, slug: 'blog', icon: 'fa-solid fa-pen-nib' },
  { id: 'case-study', label: 'Case study', count: 0, slug: 'case-study', icon: 'fa-solid fa-briefcase' },
  { id: 'huong-dan', label: 'Hướng dẫn', count: 0, slug: 'huong-dan', icon: 'fa-solid fa-circle-info' },
];
