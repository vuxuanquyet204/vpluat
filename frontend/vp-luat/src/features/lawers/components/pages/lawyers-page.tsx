...
import { LawyersFilterChips } from '@/features/lawers/components/lawyers-filter-chips';
import { LawyerCard } from '@/features/lawers/components/lawyer-card';
import { LawyerProfileModal } from '@/features/lawers/components/lawyer-profile-modal';
import { LAWYERS } from '@/features/lawers/lib/data/lawyers-data';
import type { Lawyer, LawyerSpecialty } from '@/features/lawers/types';
